...
![AWS Cognito](https://img.shields.io/badge/AWS%20Cognito-6E48AA?style=for-the-badge&logo=amazonaws&logoColor=white)
...
- **Juicy Jams** – An educational music toy powered by fruit (yes, fruit) using FPGAs + Verilog  
- **Quotr** – A full-stack AI event planner that uses GPT + APIs to automate vendor outreach  
- **Pokémon Route Optimizer** – A C++ tool that models traversal paths using TSP + Knapsack logic
